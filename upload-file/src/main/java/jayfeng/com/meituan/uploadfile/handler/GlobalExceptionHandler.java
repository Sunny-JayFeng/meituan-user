package jayfeng.com.meituan.uploadfile.handler;

import jayfeng.com.meituan.uploadfile.controller.BaseController;
import jayfeng.com.meituan.uploadfile.exception.RequestForbiddenException;
import jayfeng.com.meituan.uploadfile.exception.ServerBusyException;
...
public class GlobalExceptionHandler extends BaseController {
    ...
    public ResponseMessage handler(Exception e) {
        ...
        if (e.getClass() == UploadFileException.class) {
            ...
            return requestFail(KNOWN_EXCEPTION, exception.getMessage(), "server_error");
        }
